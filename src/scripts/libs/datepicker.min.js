var Datepicker = (function() {
  ...
  const D = {
    ...
    m(e, t, i) {
      ...
      if (isNaN(a)) {
        ...
        return (
          (a = i.monthsShort.findIndex(n)) < 0 && (a = i.months.findIndex(n)),
  ...
  const C = new WeakMap(),
    { addEventListener: O, removeEventListener: F } = EventTarget.prototype;
  function V(e, t) {
    let i = C.get(e);
    i || ((i = []), C.set(e, i)),
      t.forEach(e => {
  ...
  const { language: $, format: j, weekStart: T } = B;
  function K(e, t) {
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        d = n.language = e;
        const t = c || r[$];
        (c = Object.assign({ format: j, weekStart: T }, r[$])),
          d !== $ && Object.assign(c, r[d]),
          (n.locale = c),
          o === t.format && (o = n.format = c.format),
          m === t.weekStart && ((m = n.weekStart = c.weekStart), (n.weekEnd = P(c.weekStart)));
      }
    }
    if (a.format) {
    ...
    if (
      (void 0 !== a.minDate &&
        ((w = null === a.minDate ? l(0, 0, 1) : _(a.minDate, o, c, w)), delete a.minDate),
      void 0 !== a.maxDate &&
        ((y = null === a.maxDate ? void 0 : _(a.maxDate, o, c, y)), delete a.maxDate),
      y < w
        ? ((f = n.minDate = y), (h = n.maxDate = w))
        : (f !== w && (f = n.minDate = w), h !== y && (h = n.maxDate = y)),
      a.datesDisabled &&
    ...
    if (
      (a.daysOfWeekDisabled &&
        ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(K, [])), delete a.daysOfWeekDisabled),
      a.daysOfWeekHighlighted &&
        ((n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(K, [])),
    ...
    let k = u;
    void 0 !== a.maxView && ((k = I(a.maxView, u)), delete a.maxView),
      k !== u && (u = n.maxView = k);
    let D = p;
    if (
  ...
  class X extends z {
    ...
    setOptions(t) {
      ...
      if (
        ...
        void 0 !== t.weekStart &&
          ((this.weekStart = t.weekStart), (this.weekEnd = t.weekEnd), (i = !0)),
        t.locale)
      ) {
        const e = (this.locale = t.locale);
        (this.dayNames = e.daysMin),
          (this.switchLabelFormat = e.titleFormat),
          (this.switchLabel = S(this.picker.viewDate, e.titleFormat, e)),
          (i = !0);
      }
      if (
        (void 0 !== t.beforeShowDay &&
          (this.beforeShow = 'function' == typeof t.beforeShowDay ? t.beforeShowDay : void 0),
        void 0 !== t.calendarWeeks)
      )
        if (t.calendarWeeks && !this.calendarWeeks) {
          const e = W(U).firstChild;
          (this.calendarWeeks = { element: e, dow: e.firstChild, weeks: e.lastChild }),
      ...
      void 0 !== t.showDaysOfWeek &&
        (t.showDaysOfWeek
          ? (Y(this.dow), this.calendarWeeks && Y(this.calendarWeeks.dow))
          : (A(this.dow), this.calendarWeeks && A(this.calendarWeeks.dow))),
        i &&
    ...
    render() {
      ...
      Array.from(this.grid.children).forEach((e, t) => {
        ...
        if (
          ...
          (a < this.minDate || a > this.maxDate || this.disabled.includes(a)) && s.add('disabled'),
          this.daysOfWeekDisabled.includes(r) && (s.add('disabled'), i(this.disabled, a)),
  ...
  class G extends z {
    ...
    init(e, t = !0) {
      t &&
        ...
        this.grid.appendChild(W(r('span', 12, { 'data-month': e => e })))),
        super.init(e);
    }
    setOptions(t) {
      ...
      void 0 !== t.beforeShowMonth &&
        (this.beforeShow = 'function' == typeof t.beforeShowMonth ? t.beforeShowMonth : void 0);
    }
    updateFocus() {
      const e = new Date(this.picker.viewDate);
    ...
    render() {
      ...
      Array.from(this.grid.children).forEach((a, n) => {
        ...
        (a.className = `datepicker-cell ${this.cellClass}`),
          ...
          (t || (i && n < this.minMonth) || (s && n > this.maxMonth)) && r.add('disabled'),
          e.includes(n) && r.add('selected'),
          n === this.focused && r.add('focused'),
          this.beforeShow && this.performBeforeHook(a, n, l(this.year, n, 1));
      });
    }
    refresh() {
      const e = this.selected[this.year] || [];
  ...
  class Q extends z {
    ...
    init(e, t = !0) {
      ...
      t &&
        ...
        (this.beforeShowOption = `beforeShow${((i = this.cellClass),
      ...
      if (
        (e(t, 'minDate') &&
          (void 0 === t.minDate
            ...
            : ((this.minYear = w(t.minDate, this.step)), (this.minDate = l(this.minYear, 0, 1)))),
        e(t, 'maxDate') &&
          (void 0 === t.maxDate
            ? (this.maxYear = this.maxDate = void 0)
            : ((this.maxYear = w(t.maxDate, this.step)), (this.maxDate = l(this.maxYear, 11, 31)))),
      ...
      (this.disabled = []),
        ...
        Array.from(this.grid.children).forEach((e, t) => {
          ...
          (e.className = `datepicker-cell ${this.cellClass}`),
            ...
            this.beforeShow && this.performBeforeHook(e, s, l(s, 0, 1));
        });
    }
    refresh() {
      this.grid.querySelectorAll('.selected, .focused').forEach(e => {
  ...
  function se(t, i) {
    if (
      (void 0 !== i.title &&
        (i.title
          ? ((t.controls.title.textContent = i.title), Y(t.controls.title))
          : ((t.controls.title.textContent = ''), A(t.controls.title))),
      i.prevArrow)
    ) {
    ...
    if (
      ...
      void 0 !== i.todayBtn && (i.todayBtn ? Y(t.controls.todayBtn) : A(t.controls.todayBtn)),
  ...
  class oe {
    constructor(e) {
      ...
      const t = R.replace(/%buttonClass%/g, e.config.buttonClass),
        ...
        f = { title: r, prevBtn: o, viewSwitch: d, nextBtn: l, todayBtn: h, clearBtn: u };
      ...
      i.classList.add(`datepicker-${p}`),
        ...
        V(e, [
          [
            ...
            function(e, t) {
              t.preventDefault(),
                t.stopPropagation(),
                !e.inline && e.picker.active && e.inputField.focus();
            }.bind(null, e),
          ],
          [
            a,
          ...
          [
            ...
            function(e) {
              ...
              if (1 === e.config.todayBtnMode) {
                if ((e.setDate(c(), { render: !1 }), e.config.autohide)) return void e.hide();
              } else t.changeFocus(c());
        ...
        (this.views = [
          new X(this),
          new G(this),
          new Q(this, { id: 2, name: 'years', cellClass: 'year', step: 1 }),
          new Q(this, { id: 3, name: 'decades', cellClass: 'decade', step: 10 }),
        ]),
    ...
    show() {
      ...
      if (!e.inline) {
        ...
        t !== re(e.config.container)
          ...
          this.place(),
          'ontouchstart' in document && e.config.disableTouchKeyboard && e.inputField.blur();
      }
      Z(e, 'show');
    }
    hide() {
    ...
    place() {
      ...
      a === document.body
        ...
        'auto' === g &&
          (m < 0
            ? ((g = 'left'), (m = 10))
            : (g = m + n > c ? 'right' : 'rtl' === re(s) ? 'right' : 'left')),
        'right' === g && (m -= n - u),
  ...
  function de(e, t, i, s) {
    ...
    switch (n.id) {
      case 0:
        (c = s ? h(c, 7 * i) : t.ctrlKey || t.metaKey ? f(c, i) : h(c, i)),
          (o = h),
  ...
  function le(e, t, i) {
    ...
    return 0 !== s.length
      ? (i &&
        ...
        t.maxNumberOfDates && s.length > t.maxNumberOfDates ? s.slice(-1 * t.maxNumberOfDates) : s)
      : void 0;
  }
  return class {
    constructor(e, t = {}, i) {
    ...
    setOptions(e) {
      ...
      i.maxView < s
        ...
        : void 0 === i.startView || t.active || i.startView === s || t.changeView(i.startView),
        this.refresh();
    }
    show() {
    ...
    setDate(...e) {
      ...
      o &&
        (o.toString() !== this.dates.toString()
          ? ((this.dates = o),
            this.picker.update(),
            this.refresh(s.render ? void 0 : 'input'),
            Z(this, 'changeDate'))
          : this.refresh('input'),
    ...
    update(e) {
      ...
      i &&
        (i.toString() !== this.dates.toString()
          ? ((this.dates = i), this.picker.update(), this.refresh(), Z(this, 'changeDate'))
          : this.refresh('input'),
    ...
    refresh(e) {
      if (('input' !== e && this.picker.render(), !this.inline && 'picker' !== e)) {
        ...
        this.inputField.value !== e &&
          ((this.inputField.value = e), this.inputField.dispatchEvent(new Event('change')));
      }
    }
    enterEditMode() {
      this.inline ||
    ...
    exitEditMode(e) {
      ...
      delete this.editMode,
        ...
        t.update ? this.update(t) : (this.inputField.value = ce(this.dates, this.config));
    }
  };
})();
