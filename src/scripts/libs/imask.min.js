!(function(t, e) {
  ...
  var $ = {
    ...
    X = n(function(t) {
      ...
      (t.exports = function(t, e, r, a) {
        ...
        'function' == typeof r &&
          ...
          t !== i
            ? (s ? !l && t[e] && (o = !0) : delete t[e], o ? (t[e] = r) : B(t, e, r))
            : o
            ? (t[e] = r)
            : w(e, r);
    ...
    Mt =
      ...
      r(function() {
        ...
        : Bt;
  Ft({ target: 'Object', stat: !0, forced: Object.assign !== Mt }, { assign: Mt });
  var xt =
      ''.repeat ||
      function(t) {
        var e = String(d(this)),
    ...
    Ot = function(t) {
      return function(e, n, u) {
        ...
        return l <= s || '' == o
          ? a
          : ((i = l - s),
            (r = xt.call(o, Pt(i / o.length))).length > i && (r = r.slice(0, i)),
            t ? a + r : r + a);
      };
    },
      ...
      (function(t, e) {
        ...
        try {
          for (
            ...
            !(u = (a = s.next()).done) && (n.push(a.value), !e || n.length !== e);
            u = !0
          );
        } catch (t) {
          (i = !0), (r = t);
          ...
          },
          {
            ...
            value: function(t) {
              ...
              if (e === ee || e === ne) {
                ...
                if (e === ne || (this.lazy && !this.extractInput() && !me(this._blocks[l])))
                  return 0;
      ...
      zt(e, [
        {
          ...
          value: function(t) {
            ...
            for (
              var u = String(t.from).padStart(n, '0'), i = String(t.to).padStart(n, '0'), r = 0;
              r < i.length && i[r] === u[r];
        ...
        },
        {
          ...
          value: function(t) {
            var e = '',
              ...
              r = u[2];
            return (
              r && ((e = '0'.repeat(i.length) + r), (n = '9'.repeat(i.length) + r)),
        ...
        },
        {
          ...
          value: function() {
            ...
            return (
              this.from <= Number(s) &&
              Number(a) <= this.to &&
              (t = Wt(Yt(e.prototype), 'doValidate', this)).call.apply(t, [this].concat(l))
            );
          },
        },
        {
  ...
  (Ae.DEFAULTS = {
    ...
    (Ae.GET_DEFAULT_BLOCKS = function() {
      return {
        d: { mask: _e, from: 1, to: 31, maxLength: 2 },
        m: { mask: _e, from: 1, to: 12, maxLength: 2 },
        Y: { mask: _e, from: 1900, to: 9999 },
      };
    }),
    (he.MaskedDate = Ae);
  var be = (function() {
          ...
          value: function(t) {
            var e = t.mask,
              ...
              i = !(function t(e, n) {
                ...
                return (
                  !(!n || !e || 'function' != typeof n || 'function' != typeof e) &&
        ...
        },
        {
          ...
          set: function(t) {
            if (!this.maskEquals(t))
              if (this.masked.constructor !== fe(t)) {
                var e = pe({ mask: t });
    ...
    return (
      ...
      zt(e, [
        ...
        },
        {
          ...
          value: function() {
            ...
            (this._numberRegExpInput = new RegExp(t + '(0|([1-9]+\\d*))?' + e)),
              ...
              (this._thousandsSeparatorRegExp = new RegExp(ae(this.thousandsSeparator), 'g'));
          },
        },
        {
        ...
        },
        {
          ...
          value: function(t) {
            ...
            return (n = Wt(Yt(e.prototype), 'doPrepare', this)).call.apply(
              ...
              [
                this,
                this._removeThousandsSeparators(t.replace(this._mapToRadixRegExp, this.radix)),
              ].concat(i),
            );
          },
        },
        {
          ...
          value: function(t) {
            for (
              var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = 0, u = 0;
              u < t;
              ++u
            )
        ...
        },
        {
          ...
          value: function(t) {
            ...
            if (!this.thousandsSeparator)
              return Wt(Yt(e.prototype), '_appendCharRaw', this).call(this, t, n);
        ...
        },
        {
          ...
          value: function() {
            ...
            return new oe({ tailShift: (s - a) * this.thousandsSeparator.length });
          },
        },
        {
          key: 'nearestInputPos',
        ...
        },
        {
          key: 'doValidate',
          value: function(t) {
            var n = (t.input ? this._numberRegExpInput : this._numberRegExp).test(
        ...
        },
        {
          ...
          value: function(t) {
            ...
            var e = t.split(this.radix);
            return (
              e.length < 2 && e.push(''), (e[1] = e[1].padEnd(this.scale, '0')), e.join(this.radix)
            );
          },
        },
        {
  ...
  var Me = (function(t) {
    function e(t) {
      ...
      return (
        Nt(this, e),
        ((n = qt(this, Yt(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))).currentMask = null),
        n
      );
    }
    return (
            ...
            if (((this.currentMask = this.doDispatch(t, Object.assign({}, e))), this.currentMask))
              if (this.currentMask !== a) {
                ...
                (s.tailShift = l.inserted.length - n.length),
                  r && (s.tailShift += this.currentMask.append(r, { raw: !0, tail: !0 }).tailShift);
        ...
        },
        {
          ...
          value: function() {
            ...
            return this.currentMask
              ...
              : (n = Wt(Yt(e.prototype), 'extractTail', this)).call.apply(n, [this].concat(i));
          },
        },
        {
          key: 'doCommit',
        ...
        },
        {
          ...
          value: function() {
            ...
            return this.currentMask
              ...
              : (n = Wt(Yt(e.prototype), 'nearestInputPos', this)).call.apply(n, [this].concat(i));
          },
        },
        {
          key: 'value',
  ...
  (he.PIPE_TYPE = xe),
    ...
    (he.pipe = Oe),
    (globalThis.IMask = he),
    (t.HTMLContenteditableMaskElement = Ee),
    (t.HTMLMaskElement = Ce),
    (t.InputMask = Fe),
    (t.MaskElement = be),
    (t.Masked = ce),
    (t.MaskedDate = Ae),
